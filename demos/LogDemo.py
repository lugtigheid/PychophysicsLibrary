...
from pycholib import LogManager

def main():
    
    # Create a logging object
    test_log = LogManager.LoggingComponent('logging_test.txt')
    ...
    head = LogManager.LogHeading(test_log, fields, Margin=1) 
    ...
    foot = LogManager.LogHeading(test_log, fields, UseBreak=False, Margin=1)
