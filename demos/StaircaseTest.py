...
from pycholib import StaircasePsychComponent

# new instance of the StaircasePsychComponent
Exp = StaircasePsychComponent.StaircasePsychComponent();

# define the stepsizes - generic to every staircase
stepsize = [10, 10, 8, 6, 4, 2, 1]

# add two staircases that target the ~80% point
Exp.AddStair(StaircasePsychComponent.Staircase(up=1, down=3, initial=0, fixedstepsize=stepsize))
Exp.AddStair(StaircasePsychComponent.Staircase(up=1, down=3, initial=100, fixedstepsize=stepsize))

# add two staircases that target the ~20% point
Exp.AddStair(StaircasePsychComponent.Staircase(up=3, down=1, initial=0, fixedstepsize=stepsize))
Exp.AddStair(StaircasePsychComponent.Staircase(up=3, down=1, initial=100, fixedstepsize=stepsize))
